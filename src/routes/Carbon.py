...
def add_carbon():
    try:
        ...
        carbon = Carbon(str(id), car_id, km, eletricity, gas, total_tco2_monthly, total_tco2_yearly, trees, creation_date)
...
def update_carbon(id):
    try:
        ...
        carbon = Carbon(id, car_id, km, eletricity, gas, total_tco2_monthly, total_tco2_yearly, trees, creation_date)
